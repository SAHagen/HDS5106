...
battery around the cross-border specification. The model recovers three
...
corroborates the Burkina Faso and Ghana declines. The framework provides
a coherent route to producing district-level posterior estimates with
...
{\centering \includegraphics[width=0.7\linewidth,]{caterpillar_plot_ghana_r2} 
...
{\centering \includegraphics[width=0.7\linewidth,]{rank_plots} 
...
{\centering \includegraphics[width=0.7\linewidth,]{ppc_density} 
...
{\centering \includegraphics[width=0.7\linewidth,]{residual_boxplot_country_time} 
