...
{\centering \includegraphics[width=0.7\linewidth,]{trace_plots} 

}

\caption{ Trace Plots for model diagnostics showing convergence of the 4 chains for Ghana space-time model\label{fig:trace-plots}}\label{fig:trace_plots}
\end{figure}
